...
parser.add_argument("--output_path", type=str,default="codepile/stats/stat_dump/StackExchange")
...
stats_class = Statistics(dataset_path,read_flag="datasets")
...
stats_dataset = stats_class.get_stat_dataset(
    map_fn=map_fn, num_proc=mp.cpu_count()
